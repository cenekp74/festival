...
app.config['ROOMS_ORDERED'] = ["I", "III", "VII", "3.A", "1.A", "2.A", "V", "VI", "II", "VII", "4.A", "4.B"] # list trid podle toho, jak maji byt razeny v programu (utils.py -> get_rooms) - nemusi obsahovat vsechny tridy, co tu neni jde na konec
